...
import re
from heroesAliases import *#Spellcheck and alternate names for heroes
import discord
import io
import aiohttp
...
async def emoji(client,text,channel,message='NONE'):
	...
	await sendEmoji('resources/Emojis/'+file.capitalize(),channel)
...
def downloadEmojis():
	...
	for i in page:
		...
		print(name)
		urlretrieve(url,'resources/Emojis/'+name)
